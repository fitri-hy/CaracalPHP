...
<body class="overflow-x-hidden">
	...
	<div class="group fixed bottom-0 right-0 p-3  flex items-end justify-end w-24 h-24 ">
		<a href="https://github.com/fitri-hy/CaracalPHP/tree/35efa17cbe67b6f696536bdaa9cf8ca4c04ffa98/docs" target="_blank" class="cursor-pointer text-white shadow-lg flex items-center justify-center p-2 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 z-50 absolute hover:scale-105 hover:duration-300 hover:shadow-lg">
